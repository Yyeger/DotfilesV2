...
exports.notifyOnNewVersion = exports.Messages = exports.SuppressedKeys = void 0;
...
class Messages {
    ...
    static showUpdateMessage(version) {
        return __awaiter(this, void 0, void 0, function* () {
            const viewDocs = (0, common_1.localize)(22, null);
            const viewReleaseNotes = (0, common_1.localize)(23, null);
            const dontShowAgain = (0, common_1.localize)(24, null);
            const result = yield Messages._showMessage('info', (0, common_1.localize)(25, null, version), exports.SuppressedKeys.UpdateNotice, dontShowAgain, viewDocs, viewReleaseNotes);
    ...
    static showWelcomeMessage() {
        return __awaiter(this, void 0, void 0, function* () {
            const viewDocs = (0, common_1.localize)(22, null);
            const result = yield vscode_1.window.showInformationMessage((0, common_1.localize)(21, null), viewDocs);
            if (result === viewDocs) {
                vscode_1.commands.executeCommand("vscode.open", vscode_1.Uri.parse('https://marketplace.visualstudio.com/items/jebbs.plantuml'));
            }
            return result;
