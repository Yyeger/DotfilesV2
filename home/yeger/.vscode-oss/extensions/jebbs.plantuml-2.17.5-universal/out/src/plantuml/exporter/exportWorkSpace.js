...
exports.exportWorkSpace = void 0;
...
function exportWorkSpace(...para) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (hasEmptyFormat) {
            let userPickFormat = yield vscode.window.showQuickPick((0, appliedRender_1.appliedRender)(files[0].uri).formats(), {
                placeHolder: (0, common_1.localize)(34, null)
            });
            if (!userPickFormat)
                return;
            files.map(file => {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!para) {
            ...
            if (fs.statSync(para.fsPath).isDirectory()) {
                ...
                files.filter(file => (0, tools_1.isSubPath)(file.fsPath, folder.uri.fsPath))
                    .map(f => _files.push({
                    uri: f,
...
function doBuild(files) {
    ...
    stopWatch.start();
    (0, exportURIs_1.exportFiles)(files, common_1.bar).then((r) => __awaiter(this, void 0, void 0, function* () {
        stopWatch.stop();
        r = r;
        ...
        let btn = "";
        if (!results.length) {
            msg = (0, common_1.localize)(29, null);
            if (!errors.length) {
        ...
        msg = (0, common_1.localize)(errors.length ? 12 : 13, null, results.length);
        btn = yield vscode.window.showInformationMessage(msg, viewReport);
        if (btn === viewReport)
            showReport();
        function showReport() {
            ...
            let report = (0, common_1.localize)(28, null, results.length, diagramCnt, fileCnt, stopWatch.runTime() / 1000) + fileLst;
            if (errors.length) {
                report += "\n" + errors.reduce((p, c) => {
                    return p + (p ? "\n" : "") + c.error;
                }, "");
            }
            (0, tools_1.showMessagePanel)(report);
        }
    }));
}
