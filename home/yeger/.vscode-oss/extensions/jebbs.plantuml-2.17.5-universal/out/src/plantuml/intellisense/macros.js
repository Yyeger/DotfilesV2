...
exports.MacroDefinition = exports.MacroCallInfo = exports.macroCallOf = exports.macrosOf = void 0;
...
function macrosOf(target, position) {
    ...
    let diagram = target instanceof diagram_1.Diagram ? target : (0, tools_1.diagramAt)(target, position);
