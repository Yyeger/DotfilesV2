...
exports.makeDocumentURL = void 0;
...
function makeDocumentURL(all) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!config_1.config.server(vscode.window.activeTextEditor.document.uri)) {
            vscode.window.showWarningMessage((0, common_1.localize)(53, null));
            return;
        }
        let editor = vscode.window.activeTextEditor;
        if (!editor) {
            vscode.window.showWarningMessage((0, common_1.localize)(14, null));
            return;
        }
        ...
        if (all) {
            ...
            if (!diagrams.length) {
                vscode.window.showWarningMessage((0, common_1.localize)(15, null));
                return;
            }
        }
        else {
            ...
            if (!dg) {
                vscode.window.showWarningMessage((0, common_1.localize)(3, null));
                return;
            }
            diagrams.push(dg);
            editor.selections = [new vscode.Selection(dg.start, dg.end)];
        }
        let results = (0, urlMaker_1.MakeDiagramsURL)(diagrams, format, common_1.bar);
        common_1.bar.hide();
